def data_manipulation_challenge_domain_c(data: np.ndarray, **kwargs) -> Dict[str, Any]:
    """
    Data manipulation challenge: Test data_manipulation handling for code domain_c
    ...
    try:
        ...
        return {
            ...
            "challenge_name": "data_manipulation_challenge_domain_c",
            "description": "Test data_manipulation handling for code domain_c",
