def data_manipulation_challenge_domain_p(data: np.ndarray, **kwargs) -> Dict[str, Any]:
    """
    Data manipulation challenge: Test data_manipulation handling for code domain_p
    ...
    try:
        ...
        return {
            ...
            "challenge_name": "data_manipulation_challenge_domain_p",
            "description": "Test data_manipulation handling for code domain_p",
