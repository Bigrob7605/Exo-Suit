def p_hacking_challenge_domain_c(data: np.ndarray, **kwargs) -> Dict[str, Any]:
    """
    P-hacking challenge: Test p_hacking handling for code domain_c
    ...
    try:
        ...
        return {
            ...
            "challenge_name": "p_hacking_challenge_domain_c",
            "description": "Test p_hacking handling for code domain_c",
