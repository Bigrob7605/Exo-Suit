def edge_case_challenge_domain_p(data: np.ndarray, **kwargs) -> Dict[str, Any]:
    """
    Edge case challenge: Test edge_case handling for code domain_p
    ...
    try:
        ...
        if data.size == 0:
            return {
                ...
                "challenge_name": "edge_case_challenge_domain_p",
                "description": "Test edge_case handling for code domain_p",
