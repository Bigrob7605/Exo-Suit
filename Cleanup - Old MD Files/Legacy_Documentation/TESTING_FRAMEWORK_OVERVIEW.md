# AGENT EXO-SUIT V5.0 TESTING FRAMEWORK OVERVIEW
...
- **`EXECUTIVE_SUMMARY_LEGENDARY_ACHIEVEMENT.md`** (7.5KB, 188 lines)
...
- **`test_gpu_only.py`** (5.8KB, 174 lines)
...
- **`run-hybrid-v4.bat`** (2.5KB, 78 lines)
