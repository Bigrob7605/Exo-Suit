...
Performance (verified on real project files):
- ZSTD: 2.18x average compression
- LZ4: 1.55x average compression  
- GZIP: 2.27x average compression
- ZLIB: 2.36x average compression
